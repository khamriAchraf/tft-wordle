...
import compositions from "../../../../../data/ko-coliseum/comps";
...
export default function Puzzle() {
  ...
  return (
    <>
      <Head>
        <title>TFTYK | KO Coliseum - {comp?.name || "Puzzle"}</title>
      </Head>
      <BoardProvider setKey="15" mode="endless">
        <GameProvider setKey="15" mode="endless">
